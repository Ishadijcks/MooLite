    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$o, [
          ...
          }, vue.toDisplayString(__props.config.name), 9, _hoisted_2$h),
          _hoisted_3$a,
...
Other contributors include ${credits.contributors.join(", ")}`;
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createElementVNode("div", _hoisted_1$n, [
            ...
            }, vue.toDisplayString(__props.plugin.name), 9, _hoisted_2$g),
            _hoisted_3$9,
            vue.createElementVNode("span", {
  ...
  const _hoisted_2$f = { class: "px-2 border-b-2 border-divider" };
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$m, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.manager.plugins, (plugin) => {
            return vue.openBlock(), vue.createElementBlock("div", _hoisted_2$f, [
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("span", {
          ...
          vue.unref(credits).author !== vue.unref(credits).maintainer ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$e, " and maintained by " + vue.toDisplayString(vue.unref(credits).maintainer), 1)) : vue.createCommentVNode("", true)
        ], 8, _hoisted_1$j);
      };
    }
  });
  const _hoisted_1$i = { class: "flex flex-col h-full shadow-sm overflow-clip bg-background-game text-dark-mode shadow-space-200" };
  const _hoisted_2$d = { class: "flex flex-row h-full" };
  const _hoisted_3$8 = {
    key: 0,
  ...
  var ServerMessageType = /* @__PURE__ */ ((ServerMessageType2) => {
    ServerMessageType2["InitClientInfo"] = "init_client_info";
    ServerMessageType2["InitCharacterInfo"] = "init_character_info";
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$h, [
          vue.createElementVNode("use", { href: vue.unref(imgUrl) }, null, 8, _hoisted_2$c)
        ]);
      };
    }
  });
  ...
  const _hoisted_12$2 = /* @__PURE__ */ vue.createElementVNode("span", { class: "text-ocean-200" }, "Actions:", -1);
  const _hoisted_13$2 = { class: "absolute flex flex-row justify-between w-full text-black px-2" };
  const _hoisted_14$2 = { class: "text-xxs mt-0.5 text-midnight-600" };
  const _hoisted_15$2 = { class: "text-xxs mt-0.5 text-midnight-600" };
  const _hoisted_16$2 = { class: "text-xxs mt-0.5 text-midnight-600" };
          ...
          vue.createVNode(_sfc_main$g, {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("div", _hoisted_13$2, [
                vue.createElementVNode("span", _hoisted_14$2, "Lvl. " + vue.toDisplayString(__props.level), 1),
                vue.createElementVNode("span", _hoisted_15$2, vue.toDisplayString((__props.percentage * 100).toFixed(2)) + "%", 1),
                vue.createElementVNode("span", _hoisted_16$2, "Lvl. " + vue.toDisplayString(__props.level + 1), 1)
              ])
            ]),
            _: 1
          }, 8, ["percentage"])
  ...
  class Chat {
    ...
    updateWhisperHistory(chatWhisperHistory) {
  ...
  class Leaderboard {
    ...
    getPlayerSummary(name) {
      ...
      const skills = this.leaderboardList.flatMap((value) => {
  ...
  const _hoisted_2$9 = /* @__PURE__ */ vue.createElementVNode("span", null, "Loot Simulator", -1);
  ...
  const _hoisted_1$b = { class: "w-8 h-8" };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$b, [
          vue.createElementVNode("use", { href: vue.unref(imgUrl) }, null, 8, _hoisted_2$8)
        ]);
      };
    }
  });
  ...
  const _hoisted_15$1 = /* @__PURE__ */ vue.createElementVNode("span", { class: "font-bold" }, "Gathering", -1);
  const _hoisted_16$1 = { class: "bg-divider p-2" };
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$7, [
          ...
          vue.createElementVNode("div", _hoisted_5$3, [
                  ...
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(monsters), (monster) => {
                    return vue.openBlock(), vue.createElementBlock("tr", null, [
                      ...
                      vue.createElementVNode("td", null, [
                        ...
                        monster.loot.minCount !== monster.loot.maxCount ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_12$1, "-")) : vue.createCommentVNode("", true),
                        monster.loot.minCount !== monster.loot.maxCount ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_13$1, vue.toDisplayString(monster.loot.maxCount), 1)) : vue.createCommentVNode("", true)
                      ])
                    ]);
                  }), 256))
                ])
            ...
            vue.unref(actionsDropTable).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_14$1, [
              _hoisted_15$1,
                ...
                vue.createElementVNode("table", _hoisted_17, [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(actionsDropTable), (action) => {
                    ...
                    return vue.openBlock(), vue.createElementBlock("tr", null, [
                      ...
                      }, vue.toDisplayString(formatDropRate(action.loot.dropRate)) + "% ", 9, _hoisted_18),
                      vue.createElementVNode("td", null, [
                        vue.createElementVNode("span", null, vue.toDisplayString(action.loot.minCount), 1),
                        action.loot.minCount !== action.loot.maxCount ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_19, "-")) : vue.createCommentVNode("", true),
                        action.loot.minCount !== action.loot.maxCount ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_20, vue.toDisplayString(action.loot.maxCount), 1)) : vue.createCommentVNode("", true)
                      ])
                    ]);
                  }), 256))
                ])
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [
          ...
          !__props.plugin.hasData ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$4, "Please visit the leaderboard tab to load in the latest data")) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$2, [
            ...
            vue.unref(playerData) ? (vue.openBlock(), vue.createElementBlock("table", _hoisted_8$2, [
              ...
              selectedName.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_11$1, "Player " + vue.toDisplayString(selectedName.value) + " not found on the leaderboards", 1)) : vue.createCommentVNode("", true)
            ], 64))
          ]))
        ]);
      };
